...
<div class="page-content container bg-white" style="font-size: 14px; padding-bottom: 30px;">
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-10 offset-lg-1">
                ...
                <div class="mt-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                            ...
                            <tbody class="text-95 text-secondary-d3">
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{$order_detail->food_name}}</td>
                                    <td>{{$order_detail->food_qty}}</td>
                                    <td class="text-95">{{$order_detail->food_price}} MKK</td>
                                    <td class="text-secondary-d2">{{$order_detail->food_price * $order_detail->food_qty}} MKK</td>
                                </tr> 
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            ...
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="col-5">
                                    <span class="text-150 text-success-d3 opacity-2">{{$order->order_total}} MKK</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <span class="text-secondary-d1 text-105">Your Remark : {{$order->remark}}</span>
