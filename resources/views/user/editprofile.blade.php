...
<div class="jumbotron text-center bg-dark" style="border-radius: 0px;">
    ...
    <img src="{{ asset('defaultPhoto/defaultfood.jpg') }}" style="width: 60px; height: 60px; border: 1px solid #fff" class="rounded-circle">
    @else
    ...
    <div class="col-md-4">
        ...
        <form action="{{ url('/user/'.$user->id.'/updateprofile') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-elememt">
                ...
                <input type="file" id="file-1" name="user_image" class="form-control">
